			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap">
					<div class="fh5co-item animate-box">
						<img src="<?php echo $f['image'] ?>" class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
						<h3><?php echo $f['title']; ?></h3>
						<span class="fh5co-price">$<?php echo $f['price']; ?></span>
