			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 text-center logo-wrap">
						<div id="fh5co-logo"><a href="/">Tasty<span>.</span></a></div>
					</div>
	...
	<div id="fh5co-featured-menu" class="fh5co-section">
		<div class="container">
			<div class="row">
				...
				<?php foreach ($food as $var) {?>
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
					<div class="fh5co-item">
						<img src="<?php echo base_url(substr($var['image'], 0)); ?>" class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
						<h3><?php echo $var['title']; ?></h3>
						<span class="fh5co-price">$<?php echo $var['price']; ?></span>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="/event/<?php echo $var['id'] ?>" class="blog-bg" style="background-image: url(<?php echo $var['image'] ?>);"></a>
						<div class="blog-text">
							<span style="color: darkgrey" class=""><?php echo $var['date']; ?></span>
							<h3><a href="/event/<?php echo $var['id'] ?>"><?php echo $var['title'] ?></a></h3>
							<p><?php echo $var['description'] ?></p>
							<ul class="stuff">
								<li><i class="icon-heart2"></i>1.2K</li>
								<li><i class="icon-eye2"></i>2K</li>
								<li><a href="/event/<?php echo $var['id'] ?>">Read More<i class="icon-arrow-right22"></i></a></li>
							</ul>
						</div> 
					</div>
				</div>
